...
Report a `provides` entry that declares `at:` unmapped on `translate` ([#547](https://github.com/launchfile/launchfile/issues/547), D-next rule 5, PROVIDERS.md §10 items 5 and 8).
