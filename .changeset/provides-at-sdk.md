...
Add `at:` on a `provides` entry: the host names a published HTTP-family listener answers at, relative to the app host ([#547](https://github.com/launchfile/launchfile/issues/547), D-68).
